                        ...
                        {projects.slice(0, 5).map((project, index) => (
                            ...
                            <div className="flex justify-between items-start mb-3">
                                ...
                                <div className="flex items-center gap-3 text-sm text-slate-500">
                                    ...
                                    <span>{languageIcons[project.source_language]} → {languageIcons[project.target_language]}</span>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div className="mb-3">
                                ...
                                <Progress value={(project.status === 'ready' || project.status === 'published') ? 100 : project.completion_percentage} className="h-2 rounded-full bg-slate-200/50" />
                            </div>
